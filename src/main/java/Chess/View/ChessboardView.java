...
public class ChessboardView extends JPanel {
    ...
    private void loadIconsType0() {
        try {
            BufferedImage buf;
            buf = read(ChessboardView.class.getResourceAsStream("/blackPawn1.png"));
            blackPiecesIcons.put('P', new ImageIcon(buf));
            buf = read(ChessboardView.class.getResourceAsStream("/blackRook1.png"));
            blackPiecesIcons.put('R', new ImageIcon(buf));
            buf = read(ChessboardView.class.getResourceAsStream("/blackKing1.png"));
            blackPiecesIcons.put('W', new ImageIcon(buf));
            buf = read(ChessboardView.class.getResourceAsStream("/blackQueen1.png"));
            blackPiecesIcons.put('Q', new ImageIcon(buf));
            buf = read(ChessboardView.class.getResourceAsStream("/blackBishop1.png"));
            ...
            buf = read(ChessboardView.class.getResourceAsStream("/whiteQueen1.png"));
            whitePiecesIcons.put('Q', new ImageIcon(buf));
            buf = read(ChessboardView.class.getResourceAsStream("/whiteKing1.png"));
            whitePiecesIcons.put('W', new ImageIcon(buf));
            buf = read(ChessboardView.class.getResourceAsStream("/whiteKnight1.png"));
