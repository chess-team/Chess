...
public class ChessboardView extends JPanel {
    ...
    private void loadIconsType0() {
        try {
            BufferedImage buf;
            File pic = new File("src/main/resources/icons/blackPawn1.png");
            buf = read(pic);
            blackPiecesIcons.put('P', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackRook1.png");
            buf = read(pic);
            blackPiecesIcons.put('R', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackKing1.png");
            buf = read(pic);
            blackPiecesIcons.put('W', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackQueen1.png");
            buf = read(pic);
            blackPiecesIcons.put('Q', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackBishop1.png");
            buf = read(pic);
            blackPiecesIcons.put('B', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackKnight1.png");
            buf = read(pic);
            blackPiecesIcons.put('K', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteRook1.png");
            buf = read(pic);
            whitePiecesIcons.put('R', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whitePawn1.png");
            buf = read(pic);
            whitePiecesIcons.put('P', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteBishop1.png");
            buf = read(pic);
            whitePiecesIcons.put('B', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteQueen1.png");
            buf = read(pic);
            whitePiecesIcons.put('Q', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteKing1.png");
            buf = read(pic);
            whitePiecesIcons.put('W', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteKnight1.png");
            buf = read(pic);
    ...
    private void loadIconsType2() {
        try {
            BufferedImage buf;
            File pic = new File("src/main/resources/icons/blackPawn1small.png");
            buf = read(pic);
            blackPiecesIcons.put('P', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackRook1small.png");
            buf = read(pic);
            blackPiecesIcons.put('R', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackKing1small.png");
            buf = read(pic);
            blackPiecesIcons.put('W', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackQueen1small.png");
            buf = read(pic);
            blackPiecesIcons.put('Q', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackBishop1small.png");
            buf = read(pic);
            blackPiecesIcons.put('B', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackKnight1small.png");
            buf = read(pic);
            blackPiecesIcons.put('K', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteRook1small.png");
            buf = read(pic);
            whitePiecesIcons.put('R', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whitePawn1small.png");
            buf = read(pic);
            whitePiecesIcons.put('P', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteBishop1small.png");
            buf = read(pic);
            whitePiecesIcons.put('B', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteQueen1small.png");
            buf = read(pic);
            whitePiecesIcons.put('Q', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteKing1small.png");
            buf = read(pic);
            whitePiecesIcons.put('W', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteKnight1small.png");
            buf = read(pic);
            whitePiecesIcons.put('K', new ImageIcon(buf));
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void loadIconsType1() {
        try {
            BufferedImage buf;
            File pic = new File("src/main/resources/icons/blackPawn1medium.png");
            buf = read(pic);
            blackPiecesIcons.put('P', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackRook1medium.png");
            buf = read(pic);
            blackPiecesIcons.put('R', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackKing1medium.png");
            buf = read(pic);
            blackPiecesIcons.put('W', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackQueen1medium.png");
            buf = read(pic);
            blackPiecesIcons.put('Q', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackBishop1medium.png");
            buf = read(pic);
            blackPiecesIcons.put('B', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/blackKnight1medium.png");
            buf = read(pic);
            blackPiecesIcons.put('K', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteRook1medium.png");
            buf = read(pic);
            whitePiecesIcons.put('R', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whitePawn1medium.png");
            buf = read(pic);
            whitePiecesIcons.put('P', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteBishop1medium.png");
            buf = read(pic);
            whitePiecesIcons.put('B', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteQueen1medium.png");
            buf = read(pic);
            whitePiecesIcons.put('Q', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteKing1medium.png");
            buf = read(pic);
            whitePiecesIcons.put('W', new ImageIcon(buf));
            pic = new File("src/main/resources/icons/whiteKnight1medium.png");
            buf = read(pic);
            whitePiecesIcons.put('K', new ImageIcon(buf));
        } catch (Exception e) {
            e.printStackTrace();
